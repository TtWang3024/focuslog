...
- **A drag-first Timeline.** Left-drag reorders and glues tasks; right-drag pins a block in place and carves out a break you own; auto-fix packs the day around meals and commitments without touching your breaks.
